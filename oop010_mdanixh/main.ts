...
class Student extends Person {
    ...
    static createStudent(name: string, age: number, tags: string, role: string): Student {
...
class Message {
    constructor(public content: string, public replies: string[] = []) { }
