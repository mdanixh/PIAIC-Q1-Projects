...
class Customer {
    constructor(name, customerId, contactNo, balance = 0, accountNo) {
        this.name = name;
    ...
    do {
        ...
        switch (service.select) {
            case "Balance Inquiry":
                ...
                if (findAccount1) {
                    let name = myBank.customer.find((item) => item.accountNo == findAccount1?.accountNo);
